...
const KEYMAP: Record<string, number> = {
  ...
  // printable set for the editor (and basic later): uppercase letters,
  // space, and punctuation the 95-glyph font covers; lowercase wasd stay
  // reserved as the snake's arrow aliases
  A: 0x41, B: 0x42, D: 0x44, E: 0x45, F: 0x46, G: 0x47,
  H: 0x48, I: 0x49, J: 0x4A, K: 0x4B, L: 0x4C, M: 0x4D, N: 0x4E,
  O: 0x4F, P: 0x50, Q: 0x51, R: 0x52, S: 0x53, T: 0x54, U: 0x55,
  V: 0x56, W: 0x57, X: 0x58, Y: 0x59, Z: 0x5A,
  " ": 0x20, "!": 0x21, "#": 0x23, "$": 0x24, "%": 0x25, "&": 0x26,
  "'": 0x27, "(": 0x28, ")": 0x29, ",": 0x2C, ".": 0x2E,
  ":": 0x3A, ";": 0x3B, "<": 0x3C, ">": 0x3E, "?": 0x3F, "@": 0x40,
};
...
function bindUi(ctx: CanvasRenderingContext2D) {
  ...
  const demoNames = ["hello", "snake", "cube", "tune", "breakout", "banks", "calc", "editor", "basic", "paint", "sprites", "dodge"];
