...
- ☑ Demo/app: basic - a tiny BASIC interpreter: line-numbered programs, GOTO, LET/PRINT expressions (parens, unary minus), IF...GOTO with 16-bit compares, FOR/NEXT with signed STEP and nesting, INPUT, RND, PEEK/POKE, headless-tested through its $2500 terminal mirror
